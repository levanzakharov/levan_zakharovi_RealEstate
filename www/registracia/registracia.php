...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="menu">
      ...
      <a href="registraciaEn.php" target="_self" class="language english"> <img class="icon" src="../../photo/en.jpg" alt="en"> </a>
      <a href="registracia.php" target="_self" class="language georgian" style="background-color: #f2f2f2;"> <img class="icon" src="../../photo/geo.jpg" alt="ge"> </a>
    ...
    <div class="body">
      <div class="forma">
        ...
        <input type="text" id="username" name="username" placeholder="მომხმარებელის სახელი">
        <div class="">
          <p id="wrong_username" style = "display:none" class="wrong">შეიყვანეთ მომხმარებელის სახელი სწორად!</p>
        </div>
        <input type="email" id="email" name="email" placeholder="ელ. მისამართი">
        <div class="">
        ...
        <div class="">
          <p id="wrong_repeat_password" style = "display:none" class="wrong">შეიყვანეთ პაროლი სწორად!</p>
        </div>
        <input type="text" id="name" name="name" placeholder="სახელი">
        <div class="">
          <p id="wrong_name" style = "display:none" class="wrong">შეიყვანეთ სახელი სწორად!</p>
        </div>
        <input type="text" id="lastname" name="lastname" placeholder="გვარი">
        <div class="">
          <p id="wrong_gvari" style = "display:none" class="wrong">შეიყვანეთ გვარი სწორად!</p>
        </div>
        <input type="text" id="phone" name="phone" placeholder="ტელეფონი">
        <div class="">
          <p id="wrong_phone" style = "display:none" class="wrong">შეიყვანეთ ტელეფონი სწორად!</p>
        </div>
        <div class="shua">
          <input type="submit" name="registration" value="რეგისტრაცია" onclick="checkemail()" class="buttshesvla">
        </div>
        <div class="qveda">
          <a href="#" class="aAvtorizacia">დაგავიწყდათ პაროლი?</a>
          <a href="../autorizacia/autorizacia.php" class="aAvtorizacia" style="float:right">ავტორიზაცია</a>
        </div>
        </form>
